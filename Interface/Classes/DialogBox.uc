...
//	if ((InStr(message,"Craftomanka")>=0) || (InStr(message,"Monokini")>=0) || (InStr(message,"Amilia")>=0) || (InStr(message,"elPony")>=0) || (InStr(message,"Ica")>=0) || 		// for myself
	//	(InStr(message,"Allure")>=0) || (InStr(message,"KillaKan")>=0) || (InStr(message,"Mustakrakish")>=0) || (InStr(message,"Vampirella")>=0) || (InStr(message,"Selene")>=0) || 
	//	(InStr(message,"peepoSenpai")>=0) || (InStr(message,"Xandra")>=0) || (InStr(message,"Varta")>=0) || (InStr(message,"GPSuper")>=0) || (InStr(message,"Duracell")>=0) ||
	//	(InStr(message,"elGato")>=0)) HandleOK();
