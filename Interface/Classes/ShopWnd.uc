...
function OnClickItem( string ControlName, int index )
{
	...
	if(ControlName == "BuyTopList" || ControlName == "RefundTopList" || ControlName == "SellTopList" || ControlName == "PreviewTopList"  || ControlName == "BuyBottomList" || ControlName == "RefundBottomList" || ControlName == "SellBottomList" || ControlName == "PreviewBottomList")
	{
	...
	if( IsKeyDown( IK_Alt ))
	{
		if(ControlName == "RefundTopList" || ControlName == "SellTopList")
		{
			MoveItemTopToBottom( index, true );
		}
		else if (ControlName == "BuyTopList" || ControlName == "PreviewTopList")
		{
			MoveItemTopToBottom( index, false );
		}
		else if (ControlName == "BuyBottomList" || ControlName == "RefundBottomList" || ControlName == "SellBottomList")
		{
			MoveItemBottomToTop( index, true );
		}
		else if (ControlName == "PreviewBottomList")
		{
			MoveItemBottomToTop( index, false );
		}
	}
