class PartyMatchMakeRoomWnd extends UIScriptEx;
...
function OnLoad()
{
	...
	{
		MinLevelEditBox = EditBoxHandle(GetHandle("PartyMatchMakeRoomWnd.MinLevelEditBox"));	
		MaxLevelEditBox = EditBoxHandle(GetHandle("PartyMatchMakeRoomWnd.MaxLevelEditBox"));	
	}
	else
	{
...
function OnOKButtonClick()
{
	...
	Script = PartyMatchRoomWnd( GetScript( "PartyMatchRoomWnd" ) );
	Script.Recreate = false;
