...
/** 
 *  x,y 창을 랜덤으로 이동 시킨다 (그린GM팀:이강환 쪽 건의) 
 *  보안상 이슈
 **/
...
/** 입력 에디터 박스 처럼 보이도록 텍스쳐 이미지를 변경하고 입력 포커스를 지정한다. */
