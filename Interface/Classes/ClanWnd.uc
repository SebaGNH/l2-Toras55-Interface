...
function AddToList( int idx )
{
	...
	else
	{
		...
		else
		{
			...
			record.LVDataList[2].szTexture = GetDetailedClassIconName(m_memberList[0].m_array[i].classID, 0);
	...
	for( i=0 ; i < m_memberList[idx].m_array.Length ; ++i )
	{
		...
		record.LVDataList[2].szTexture = GetDetailedClassIconName(m_memberList[idx].m_array[i].classID, 0);
		record.LVDataList[2].nTextureWidth = 14;
		record.LVDataList[2].nTextureHeight = 14;
		record.LVDataList[3].nTextureWidth = 31;
		record.LVDataList[3].nTextureHeight = 11;
