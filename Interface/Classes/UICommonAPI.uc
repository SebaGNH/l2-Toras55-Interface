...
{
	if ((a_ItemInfo.Enchanted <=19) &&(a_ItemInfo.Enchanted >0) && (a_ItemInfo.SlotBitType >0)) 
		a_ItemInfo.ForeTexture = "pug.enchant" $ String(a_ItemInfo.Enchanted);
...
function int GetTalismanSkillID(int id)
{
	switch (id)
	{
		case 35706://Blue Talisman of Power
			return 23754;
		case 35707://Blue Talisman of Power
			return 23755;
		break;
...
{
	local string addtext;
	addtext = "";
	if (!class'UIAPI_CHECKBOX'.static.IsChecked("FlexOptionWnd.enableDetailIcons"))
	{
		return GetClassIconName(ClassID);
	}
	else
	{
		if (iconType > 0) addtext = "16";
		switch (ClassID)
		{
								// human
			case 0:
				return "pug.fighter" $ addtext;				// human fighter
			break;
			
			case 1:
			return "pug.warrior" $ addtext;				// warrior
			break;
			
			case 2:
				return "pug.gladiator" $ addtext;			// gladiator
			break;
			
			case 3:
				return "pug.warlord" $ addtext;				// warlord
			break;
		
			case 4:
				return "pug.knight" $ addtext;				// human knight
			break;
		
			case 5:
				return "pug.tank" $ addtext;				// paladin
			break;
		
			case 6:
				return "pug.tank" $ addtext;				// dark avenger
			break;
		
			case 7:
				return "pug.rogue" $ addtext;				// rogue
			break;
		
			case 8:
				return "pug.treasurehunter" $ addtext;		// treasure hunter
			break;
		
			case 9:
				return "pug.hawkeye" $ addtext;				// hawkeye
			break;
		
			case 10:
				return "pug.mage" $ addtext;				// human mystic
			break;
		
			case 11:
				return "pug.wizard" $ addtext;				// human wizard
			break;
		
			case 12:
				return "pug.sorcerer" $ addtext;			// sorcerer
			break;
		
			case 13:
				return "pug.necromancer" $ addtext;			// necromancer
			break;
		
			case 14:
				return "pug.warlock" $ addtext;				// warlock
			break;
		
			case 15:
				return "pug.elvenoracle" $ addtext;			// cleric
			break;
		
			case 16:
				return "pug.bishop" $ addtext;				// bishop
			break;
		
			case 17:
				return "pug.prophet" $ addtext;				// prophet
			break;
		
			case 88:
				return "pug.duelist" $ addtext;				// duelist
			break;
		
			case 89:
				return "pug.dreadnought" $ addtext;			// dreadnought
			break;
		
			case 90:
				return "pug.phoenixknight" $ addtext;		// phoenix knight
			break;
		
			case 91:
				return "pug.hellknight" $ addtext;			// hell knight
			break;
		
			case 92:
				return "pug.saggitarius" $ addtext;			// saggitarius
			break;
		
			case 93:
				return "pug.adventurer" $ addtext;			// adventurer
			break;
		
			case 94:
				return "pug.archmage" $ addtext;			// archmage
			break;
		
			case 95:
				return "pug.soultaker" $ addtext;			// soultaker
			break;
		
			case 96:
				return "pug.arcanalord" $ addtext;			// arcana lord
			break;
		
			case 97:
				return "pug.cardinal" $ addtext;			// cardinal
			break;
		
			case 98:
				return "pug.hierophant" $ addtext;			// hierophant
			break;
		
								// elven
		
			case 18:
				return "pug.fighter" $ addtext;				// elven fighter
			break;
		
			case 19:
				return "pug.knight" $ addtext;				// elven knight
			break;
		
			case 20:
				return "pug.tank" $ addtext;				// temple knight
			break;
		
			case 21:
				return "pug.swordsinger" $ addtext;			// sword singer
			break;
		
			case 22:
				return "pug.rogue" $ addtext;				// elven scout
			break;
		
			case 23:
				return "pug.plainswalker" $ addtext;		// plains walker
			break;
		
			case 24:
				return "pug.silverranger" $ addtext;		// silver ranger
			break;
		
			case 25:
				return "pug.mage" $ addtext;				// elven mystic
			break;
		
			case 26:
				return "pug.ewizard" $ addtext;				// elven wizard
			break;
		
			case 27:
				return "pug.spellsinger" $ addtext;			// spellsinger
			break;
		
			case 28:
				return "pug.elementalsummoner" $ addtext;	// elemental summoner
			break;
		
			case 29:
				return "pug.elvenoracle" $ addtext;			// elven oracle
			break;
		
			case 30:
				return "pug.elvenelder" $ addtext;			// elven elder
			break;
		
			case 99:
				return "pug.evatemplar" $ addtext;			// eva templar
			break;
		
			case 100:
				return "pug.swordmuse" $ addtext;			// sword muse
			break;
		
			case 101:
				return "pug.windrider" $ addtext;			// wind rider
			break;
		
			case 102:
				return "pug.moonlightsentinel" $ addtext;	// moonlight sentinel
			break;
		
			case 103:
				return "pug.mysticmuse" $ addtext;			// mystic muse
			break;
		
			case 104:
				return "pug.elementalmaster" $ addtext;		// elemental master
			break;
		
			case 105:
				return "pug.evasaint" $ addtext;			// eva saint
			break;
		
								// dark
							
			case 31:
				return "pug.fighter" $ addtext;				// dark fighter
			break;
		
			case 32:
				return "pug.knight" $ addtext;				// palus knight
			break;
		
			case 33:
				return "pug.tank" $ addtext;				// shillien knight
			break;
		
			case 34:
				return "pug.bladedancer" $ addtext;			// bladedancer 
			break;
		
			case 35:
				return "pug.rogue" $ addtext;				// assassin
			break;
		
			case 36:
				return "pug.abysswalker" $ addtext;			// abyss walker
			break;
		
			case 37:
				return "pug.phantomranger" $ addtext;		// phantom ranger
			break;
		
			case 38:
				return "pug.mage" $ addtext;				// dark mystic
			break;
		
			case 39:
				return "pug.dewizard" $ addtext;			// dark wizard
			break;
		
			case 40:
				return "pug.spellhowler" $ addtext;			// spellhowler
			break;
			
			case 41:
				return "pug.phantomsummoner" $ addtext;		// phantom summoner
			break;
			
			case 42:
				return "pug.elvenoracle" $ addtext;			// shillien oracle
			break;
			
			case 43:
				return "pug.shillienelder" $ addtext;		// shillien elder
			break;
			
			case 106:
				return "pug.shillientemplar" $ addtext;		// shillien templar
			break;
			
			case 107:
				return "pug.spectraldancer" $ addtext;		// spectral dancer
			break;
			
			case 108:
				return "pug.ghosthunter" $ addtext;			// ghost hunter
			break;
			
			case 109:
				return "pug.ghostsentinel" $ addtext;		// ghost sentinel
			break;
			
			case 110:
				return "pug.stormscreamer" $ addtext;		// storm screamer
			break;
			
			case 111:
				return "pug.spectralmaster" $ addtext;		// spectral master
			break;
			
			case 112:
				return "pug.shilliensaint" $ addtext;		// shillien saint
			break;
								
								// Orc
								
			case 44:
				return "pug.fighter" $ addtext;				// orc fighter
			break;
			
			case 45:
				return "pug.raider" $ addtext;				// orc raider
			break;
			
			case 46:
				return "pug.destroyer" $ addtext;			// orc destroyer
			break;
			
			case 47:
				return "pug.monk" $ addtext;				// orc monk
			break;
			
			case 48:
				return "pug.tyrant" $ addtext;				// orc tyrant
			break;
			
			case 49:
				return "pug.mage" $ addtext;				// orc mystic
			break;
			
			case 50:
				return "pug.shaman" $ addtext;				// orc shaman
			break;
			
			case 51:
				return "pug.overlord" $ addtext;			// overlord
			break;
			
			case 52:
				return "pug.warcryer" $ addtext;			// warcryer
			break;
			
			case 113:
				return "pug.titan" $ addtext;				// titan
			break;
			
			case 114:
				return "pug.grandk" $ addtext;				// grand khavatari
			break;
			
			case 115:
				return "pug.dominator" $ addtext;			// dominator
			break;
			
			case 116:
				return "pug.doomcryer" $ addtext;			// doomcryer
			break;
			
								// dwarf
								
			case 53:
				return "pug.fighter" $ addtext;				// dwarven fighter
			break;
			
			case 54:
				return "pug.scavenger" $ addtext;			// scavenger
			break;
			
			case 55:
				return "pug.bounty" $ addtext;				// bounty hunter
			break;
			
			case 56:
				return "pug.artisan" $ addtext;				// artisan
			break;
			
			case 57:
				return "pug.warsmith" $ addtext;			// warsmith
			break;
			
			case 117:
				return "pug.fortune" $ addtext;				// fortune seeker
			break;
			
			case 118:
				return "pug.maestro" $ addtext;				// maestro
			break;
								
								// kamael
								
			case 123:
				return "pug.fighter" $ addtext;				// male soldier
			break;
			
			case 124:
				return "pug.fighter" $ addtext;				// female soldier
			break;
			
			case 125:
				return "pug.wardertrooper" $ addtext;		// dragoon
			break;
			
			case 126:
				return "pug.wardertrooper" $ addtext;				// warder
			break;
			
			case 127:
				return "pug.berserker" $ addtext;			// berserker
			break;
			
			case 128:
				return "pug.soulbreaker" $ addtext;			// male soul breaker
			break;
			
			case 129:
				return "pug.soulbreaker" $ addtext;			// female soul breaker
			break;
			
			case 130:
				return "pug.arbaletster" $ addtext;			// arbalester
			break;
			
			case 131:
				return "pug.doombringer" $ addtext;			// doombringer
			break;
			
			case 132:
				return "pug.soulhound" $ addtext;			// male soul hound
			break;
			
			case 133:
				return "pug.soulhound" $ addtext;			// female soul hound
			break;
			
			case 134:
				return "pug.trickster" $ addtext;			// trickster
			break;
			
			case 135:
				return "pug.inspector" $ addtext;			// inspector
			break;
			
			case 136:
				return "pug.judicator" $ addtext;			// judicator
			break;
