...
var WindowHandle	h_OnScreenDmg;
...
var CheckBoxHandle	c_enableAutoPetSS;
var CheckBoxHandle	c_enableScreenDmg;
var CheckBoxHandle	c_enableMultiplier;
...
var CheckBoxHandle	c_enableDetailIcons;
var CheckBoxHandle	c_enableMacroPanel;
var CheckBoxHandle	c_enableAnimMacro;

var ComboBoxHandle	cb_ECastAnchor;
var ComboBoxHandle	cb_Noblesse;

var EditBoxHandle 	e_getYMySkillCast;
var EditBoxHandle 	e_getXECast;
var EditBoxHandle 	e_getYECast;
var EditBoxHandle 	e_getDamageX;
var EditBoxHandle 	e_getDamageY;
var EditBoxHandle 	e_getMana;
var EditBoxHandle 	e_getKey;
var EditBoxHandle 	e_getSubKey;
var EditBoxHandle 	e_autoMacroDelay;
...
function OnLoad()
{
	...
	h_OnScreenDmg = GetWindowHandle("OnScreenDmg");
	//CheckBoxes
	...
	c_enableAutoPetSS = GetCheckBoxHandle("FlexOptionWnd.enableAutoPetSS");
	c_enableScreenDmg = GetCheckBoxHandle("FlexOptionWnd.enableScreenDmg");
	c_enableMultiplier = GetCheckBoxHandle("FlexOptionWnd.enableMultiplier");
	...
	c_enableDetailIcons = GetCheckBoxHandle("FlexOptionWnd.enableDetailIcons");
	c_enableMacroPanel = GetCheckBoxHandle("FlexOptionWnd.enableMacroPanel");
	c_enableAnimMacro = GetCheckBoxHandle("FlexOptionWnd.enableAnimMacro");
	//EditBoxes
	...
	e_getDamageX = GetEditBoxHandle("FlexOptionWnd.DamageX");
	e_getDamageY = GetEditBoxHandle("FlexOptionWnd.DamageY");
	...
	e_autoMacroDelay = GetEditBoxHandle("FlexOptionWnd.AutoMacroDelay");
	...
	cb_Noblesse =  GetComboBoxHandle("FlexOptionWnd.cShowNoblesse");
	...
	cb_Noblesse.Clear();
	cb_Noblesse.AddString("Buff");
	cb_Noblesse.AddString("Debuff");
	cb_Noblesse.AddString("Trigger");
...
function LoadINISets()
{
	...
	GetINIString("MacroSettings", "AutoMacroDelay", valueS, "PatchSettings");
	e_autoMacroDelay.SetString(valueS);
	...
	GetINIInt("Buff Control", "ShowNobl", temp, "PatchSettings");
	switch (temp)
	{
		case 0:
		//	h_ECast.SetAnchor("StatusWnd", "BottomLeft", "BottomLeft", 2, 38);
			cb_Noblesse.SetSelectedNum(0);
		break;
		case 1:
		//	class'UIAPI_WINDOW'.static.ShowWindow("TargetStatusWnd");
		//	h_ECast.SetAnchor("TargetStatusWnd", "BottomLeft", "BottomLeft", 2, 38);
			cb_Noblesse.SetSelectedNum(1);
		//	class'UIAPI_WINDOW'.static.HideWindow("TargetStatusWnd");
		break;
		case 2:
		//	class'UIAPI_WINDOW'.static.ShowWindow("OlympiadTargetWnd");
		//	h_ECast.SetAnchor("OlympiadTargetWnd", "TopLeft", "TopLeft", 2, -38);
			cb_Noblesse.SetSelectedNum(2);
		//	class'UIAPI_WINDOW'.static.HideWindow("OlympiadTargetWnd");
		break;
	}

	GetINIBool("WindowsCheks", "MacroPanelWnd", temp, "PatchSettings");
	if (temp == 1)
	{
		if (GetUIState() == "GAMINGSTATE") class'UIAPI_WINDOW'.static.ShowWindow("MacroPanelWnd");
		c_enableMacroPanel.SetCheck(true);
	}
	else
	{
		class'UIAPI_WINDOW'.static.HideWindow("MacroPanelWnd");
		c_enableMacroPanel.SetCheck(false);
	}
	GetINIBool("MacroSettings", "AnimatedMacro", temp, "PatchSettings");
	if (temp == 1)
	{
		c_enableAnimMacro.SetCheck(true);
	}
	else
	{

		c_enableAnimMacro.SetCheck(false);
	}
	GetINIBool("WindowsCheks", "RadarMapWnd", temp, "PatchSettings");
	if (temp == 1)
	{
		if (GetUIState() == "GAMINGSTATE") class'UIAPI_WINDOW'.static.ShowWindow("RadarMapWnd");
	...
	if (temp == 1)
	{
		if (GetUIState() == "GAMINGSTATE")  class'UIAPI_WINDOW'.static.ShowWindow("OlympiadDmgWnd");
	...
	if (temp == 1)
	{
		if (GetUIState() == "GAMINGSTATE") class'UIAPI_WINDOW'.static.ShowWindow("ItemControlWnd");
	...
	if (temp == 1)
	{
		if (GetUIState() == "GAMINGSTATE") class'UIAPI_WINDOW'.static.ShowWindow("AutoSS");
	...
	else
	{
		...
		class'UIAPI_WINDOW'.static.DisableWindow("FlexOptionWnd.enableAutoPetSS");
	}
	
	GetINIBool("WindowsCheks", "AutoPetSS", temp, "PatchSettings");
	
	if (temp == 1)
	{
		//class'UIAPI_WINDOW'.static.ShowWindow("AutoSS");
		c_enableAutoPetSS.SetCheck(true);
		script_ss = AutoSS(GetScript("AutoSS"));
		script_ss.AutoSSPet.ShowWindow();
		script_ss.Shot3.ShowWindow();
		script_ss.Shot4.ShowWindow();
		script_ss.texBG3.ShowWindow();
		script_ss.texBG4.ShowWindow();
		//script_ss.Animation3.ShowWindow();
		//script_ss.Animation4.ShowWindow();	
	}
	else
	{
		//class'UIAPI_WINDOW'.static.HideWindow("AutoSS");
		c_enableAutoPetSS.SetCheck(false);
		script_ss = AutoSS(GetScript("AutoSS"));
		script_ss.AutoSSPet.HideWindow();
		script_ss.Shot3.HideWindow();
		script_ss.Shot4.HideWindow();
		script_ss.texBG3.HideWindow();
		script_ss.texBG4.HideWindow();
		script_ss.Animation3.HideWindow();
		script_ss.Animation4.HideWindow();		
	}

	GetINIInt("WindowsPositions", "OnScreenDmgPosX", valueX, "PatchSettings");
	GetINIInt("WindowsPositions", "OnScreenDmgPosY", valueY, "PatchSettings");
	e_getDamageX.SetString(string(valueX));
	e_getDamageY.SetString(string(valueY));
	h_OnScreenDmg.SetAnchor("", "TopCenter", "TopCenter", valueX, valueY);	
	
	GetINIBool("WindowsCheks", "OnScreenDmg", temp, "PatchSettings");
	if (temp == 1)
	{
		if (GetUIState() == "GAMINGSTATE") class'UIAPI_WINDOW'.static.ShowWindow("OnScreenDmg");
	...
	if (temp == 1)
	{
		c_enableMultiplier.SetCheck(true);
	}
	else
	{
		c_enableMultiplier.SetCheck(false);
	}
	...
	GetINIBool("WindowsCheks", "DetailIcons", temp, "PatchSettings");
	if (temp == 1)
	{
		c_enableDetailIcons.SetCheck(true);
	}
	else
	{
		c_enableDetailIcons.SetCheck(false);
	}
...
function OnClickCheckBox(string strID)
{
	...
	switch (strID)
	{
		case "enableMacroPanel":
			OnClickShowHide(c_enableMacroPanel,"MacroPanelWnd");
		break;
		case "showRadar":
		...
		break;
		case "enableAutoPetSS":
			OnClickShowHide(c_enableAutoPetSS,"AutoPetSS");
		break;
		...
		break;
		case "enableMultiplier":
			OnClickCheck(c_enableMultiplier,"Multiplier");
		break;
		...
		break;
		case "enableDetailIcons":
			OnClickCheck(c_enableDetailIcons,"DetailIcons");
		break;		
		case "enableAnimMacro":
			OnClickCheck(c_enableAnimMacro,"AnimatedMacro");
		break;	
	}
}
...
function OnComboBoxItemSelected (string strID, int Index)
{
	switch (strID)
	{
		...
		break;
		case "cShowNoblesse":
			SetINIInt("Buff Control", "ShowNobl", Index, "PatchSettings");
		break;
	}
}
...
function OnApplyBtn()
{
	...
	if (e_autoMacroDelay.GetString() != "")
	{
		valueX = int(e_autoMacroDelay.GetString());
		if (valueX >= 0 && valueX <= 9999)
		{
			SetINIInt("MacroSettings", "AutoMacroDelay", valueX, "PatchSettings");
		}
	...
	if (e_getDamageX.GetString() != "" && e_getDamageY.GetString() != "")
	{
		valueX = int(e_getDamageX.GetString());
		valueY = int(e_getDamageY.GetString());
		if (valueX >= -userX/2 && valueX <= userX/2 && valueY <= userY)
		{
			h_OnScreenDmg.SetAnchor("", "TopCenter", "TopCenter", valueX, valueY);
			SetINIInt("WindowsPositions", "OnScreenDmgPosX", valueX, "PatchSettings");
			SetINIInt("WindowsPositions", "OnScreenDmgPosY", valueY, "PatchSettings");
		}	
	}
...
function OnClickShowHide(CheckBoxHandle handle, string wndname)
{
	...
	if (handle.IsChecked())
	{
		if (handle == c_enableAutoPetSS)
		{	
			script_ss = AutoSS(GetScript("AutoSS"));
			script_ss.AutoSSPet.ShowWindow();
			script_ss.Shot3.ShowWindow();
			script_ss.Shot4.ShowWindow();
			script_ss.FrameSS3.ShowWindow();
			script_ss.FrameSS4.ShowWindow();
			//script_ss.Animation3.ShowWindow();
			//script_ss.Animation4.ShowWindow();
			script_ss.texBG3.ShowWindow();
			script_ss.texBG4.ShowWindow();
			script_ss.isChargedtPetSoul = false;
			script_ss.isChargedtPetSpirit = false;
			script_ss.ShowPet = true;
			SetINIBool("WindowsCheks", wndname, true, "PatchSettings");
			ExecuteEvent(EV_UpdateUserInfo);
		}
		else
		{	
			if (handle == c_enableAutoSS)
			{
				class'UIAPI_WINDOW'.static.EnableWindow("FlexOptionWnd.enableAutoPetSS");
				script_ss = AutoSS(GetScript("AutoSS"));
				script_ss.AutoSSPet.ShowWindow();
				c_enableAutoPetSS.SetCheck(true);
				script_ss.Shot3.ShowWindow();
			...
			//	script_ss.Animation4.ShowWindow();
				...
				script_ss.isChargedtPetSpirit = false;
				script_ss.ShowPet = true;
				script_ss.ShowMy = true;
				SetINIBool("WindowsCheks", "AutoPetSS", true, "PatchSettings");				
			}
			
			if (handle == c_enableAutoSouls)
			{
				script_as = AutoSouls(GetScript("AutoSouls"));
				script_as.AnimTex.Stop();
				script_as.AnimTex.HideWindow();
				script_as.isPause =  true;
			}
	...
	else
	{
		...
		{	
			...
			script_ss.Animation3.HideWindow();
			script_ss.Animation4.HideWindow();
			script_ss.FrameSS3.HideWindow();
			script_ss.FrameSS4.HideWindow();
			script_ss.texBG3.HideWindow();
			script_ss.texBG4.HideWindow();
			script_ss.ShowPet = false;
			SetINIBool("WindowsCheks", wndname, false, "PatchSettings");
			ExecuteEvent(EV_UpdateUserInfo);
		}
		else
		{
			if (handle == c_enableAutoSS)
			{
				...
				class'UIAPI_WINDOW'.static.DisableWindow("FlexOptionWnd.enableAutoPetSS");
				script_ss.ShowPet = false;
				script_ss.ShowMy = false;
				SetINIBool("WindowsCheks", "AutoPetSS", false, "PatchSettings");				
			}
