...
//var TextureHandle PCCafeTexture;
...
//		PCCafeTexture =  TextureHandle PCCafeTexture;
...
function Refresh(int nShow)
{
	...
	if( 0 != m_AddPoint && nShow != 0 )
	{
		...
		class'UIAPI_WINDOW'.static.SetAnchor( "PCCafeEventWnd.PointAddTextBox", "PCCafeEventWnd", "TopRight", "TopRight", -5, 7 );
